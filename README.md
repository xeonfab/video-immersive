...
| Skill | Rôle | Invoque |
|---|---|---|
| `/shotlist-generator` | À partir d'un brief hôtel + photos dispo, génère la shot-list complète (prompts caméra, durée, structure narrative façon Castel Beau Site) | En premier, une fois le projet scaffoldé |
